export const MenuSnippets = {
  ...
  "Horizontal Menu and Collapsible Submenu": {
    preview: (
      <div className="card card-primary-80 min-h-[392px] my-2 p-5 flex flex-row gap-2 justify-center items-start">
        <div className="card">
          <ul className="menu menu-horizontal">
            <li><a>Link 1</a></li>
            <li>
  ...
  "Menu Sizes": {
    preview: (
      <div className="card card-primary-80 min-h-[480px] my-2 p-5 flex flex-row gap-2 justify-center items-start">
        <div className="card">
