export const BadgeSnippets = {
  "Solid Badge": {
    preview: (
      <span className="badge-default">Solid</span>
    ),
  ...
  "Outlined Badge": {
    preview: (
      <span className="badge-default badge-outlined">Outlined</span>
    ),
  ...
  "Dot Badge (?)": {
    preview: (
      <span className="badge-default badge-dot"></span>
    ),
  ...
  "Badge Sizes": {
    preview: (
      <>
      <span className="badge-default badge-sm">Small</span>
