export const CardSnippets = {
  "Simple Card": {
    preview: (
      <div className="card w-96">
        <div className="_card-body">
          <h3 className="_card-title">Play Songs</h3>
          <span>From your recent favorites</span>

          <div className="_card-actions justify-end">
    ...
    htmlCode: "<div class=\"card w-96\">\n  <div class=\"_card-body\">\n    <h3 class=\"_card-title\">Play Songs</h3>\n    <span>From your recent favorites</span>\n\n    <div class=\"_card-actions justify-end\">\n      <button class=\"btn --ghost\">Cancel</button>\n      <button class=\"btn btn-warning\">Get Started</button>\n    </div>\n  </div>\n</div>",
  ...
  "Card w/ Image on Top": {
    preview: (
      <div className="card w-96">
        ...
        <div className="_card-body">
          <h5 className="_card-title">Mechanical Keyboards</h5>
