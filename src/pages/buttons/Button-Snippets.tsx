export const ButtonSnippets = {
  "Solid Button": {
    preview: (
      <button className="btn-default">Solid</button>
    ),
  ...
  "Outlined Button": {
    preview: (
      <button className="btn-default btn-outlined">Outlined</button>
    ),
  ...
  "Circle Button": {
    preview: (
      <>
      <button className="btn-default btn-circle">
        <span className="material-icons-round">
          search
        </span>
      </button>
      <button className="btn-default btn-circle btn-outlined">
        <span className="material-icons-round">
          search
        </span>
      </button>
      <button className="btn-default btn-circle btn-ghost">
        <span className="material-icons-round">
          search
        </span>
      </button>
  ...
  "Button Size": {
    preview: (
      <>
      <button className="btn-default btn-sm">Small</button>
  ...
  "Active Button": {
    preview: (
      <>
      <button className="btn-default active">Default</button>
  ...
  "Disabled Button": {
    preview: (
      <button className="btn-default" disabled="disabled">Disabled</button>
    ),
