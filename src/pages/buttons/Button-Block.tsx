...
const ButtonBlock = (props) => {
  const tabContent = {
    "preview": (
      <div className="card-primary80 min-h-[100px] p-5 flex flex-row gap-2 justify-center items-center overflow-x-auto">
        { props.preview }
      </div>
    ),
    "html": (
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-row gap-4 mx-4 justify-between">
        <div className="flex flex-row gap-2 items-center">
          ...
          { props.type === "Button Size" ? <span className="badge-info badge-sm">In Dev</span> : null }
        </div>
        <div className="flex flex-row gap-2 items-center">
