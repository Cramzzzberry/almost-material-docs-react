...
export default function BadgeSizes() {const tabs = {
  "preview": (
...
return (
  ...
  <div className="flex flex-col gap-4">
    ...
    <div className="flex flex-row gap-4 mx-4 justify-between">
      <h3 className="font-semibold">Badge Sizes</h3>
