export const CheckboxSnippets = {
  "Checkbox": {
    ...
    htmlCode: "<input type=\"checkbox\" defaultChecked=\"checked\" class=\"checkbox\" />",
    jsxCode: "<input type=\"checkbox\" defaultChecked=\"checked\" className=\"checkbox\" />",
  },
  "Checkbox w/ colors": {
    preview: (
      <>
      <input type="checkbox" defaultChecked="checked" className="checkbox checkbox-primary" />
