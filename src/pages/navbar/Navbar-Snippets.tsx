...
export const NavbarSnippets = {
  ...
  "Navigation Bar w/ Dropdown": {
            ...
            <ul className="menu --horizontal">
              ...
              <li>
                <div className="dropdown">
                  ...
                  <div tabIndex="0" className="_dropdown-content z-[0] card">
    ...
    htmlCode: "<div class=\"navbar bg-white\">\n  <div class=\"_navbar-start\">\n    <ul class=\"menu --horizontal\">\n      <li><a>Meals</a></li>\n      <li><a>Mix & Match</a></li>\n      <li>\n        <div class=\"dropdown\">\n          <button tabIndex=\"0\" class=\"btn --ghost\">More</button>\n          <div tabIndex=\"0\" class=\"_dropdown-content z-[1] card\">\n            <ul class=\"menu w-56\">\n              <li><a>Link 1</a></li>\n              <li><a>Link 2</a></li>\n              <li><a>Link 3</a></li>\n            </ul>\n          </div>\n        </div>\n      </li>\n    </ul>\n  </div>\n\n  <div class=\"_navbar-end\">\n    <ul class=\"menu --horizontal\">\n      <li><a>Almost Material</a></li>\n    </ul>\n  </div>\n</div>",
    jsxCode: "<div className=\"navbar bg-white\">\n  <div className=\"_navbar-start\">\n    <ul className=\"menu --horizontal\">\n      <li><a>Meals</a></li>\n      <li><a>Mix & Match</a></li>\n      <li>\n        <div className=\"dropdown\">\n          <button tabIndex=\"0\" className=\"btn --ghost\">More</button>\n          <div tabIndex=\"0\" className=\"_dropdown-content z-[1] card\">\n            <ul className=\"menu w-56\">\n              <li><a>Link 1</a></li>\n              <li><a>Link 2</a></li>\n              <li><a>Link 3</a></li>\n            </ul>\n          </div>\n        </div>\n      </li>\n    </ul>\n  </div>\n\n  <div className=\"_navbar-end\">\n    <ul className=\"menu --horizontal\">\n      <li><a>Almost Material</a></li>\n    </ul>\n  </div>\n</div>",
  },
